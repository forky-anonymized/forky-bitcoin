...
class CChainState
{
//Anonymized_Author_A: Move public to access
//protected:
public:
    /**
...
public:
    ...
    bool FuzzProcessNewBlock(BlockValidationState& state, const CChainParams& chainparams, const std::shared_ptr<const CBlock>& block, bool force_processing, bool* new_block) LOCKS_EXCLUDED(cs_main);
