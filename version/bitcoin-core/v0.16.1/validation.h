...
// Anonymized_Author_A: From this moved from validation.cpp
/**
 * Global state
 */
// Anonymized_Author_A: Remove anonymous namespace to access
//namespace {
 ...
 */
class CChainState {
//Anonymized_Author_A: Move private to public to access
public:
    /**
