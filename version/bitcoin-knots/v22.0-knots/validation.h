...
public:
    ...
    bool FuzzProcessNewBlock(BlockValidationState state, const CChainParams& chainparams, const std::shared_ptr<const CBlock>& block, bool force_processing, bool* new_block);
    /**
