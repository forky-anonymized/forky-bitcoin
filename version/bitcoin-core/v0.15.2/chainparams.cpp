...
public:
    CRegTestParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        // Anonymized_Author_A: Set chainparam of DEPLOYMENT_SEGWIT nStartTime and nTimeout as -1 and MAX : ALWAYS_ACTIVE
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = -1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 9223372036854775807ULL;
